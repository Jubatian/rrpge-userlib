;
; RRPGE User Library functions - Display List single buffer wrappers
;
...
;
; Implementation of us_dlist_sb_setptr
;
us_dlist_sb_setptr_i:
...
;
; Implementation of us_dlist_sb_add
;
us_dlist_sb_add_i:
...
;
; Implementation of us_dlist_sb_addxy
;
us_dlist_sb_addxy_i:
...
;
; Implementation of us_dlist_sb_addbg
;
us_dlist_sb_addbg_i:
...
;
; Implementation of us_dlist_sb_addlist
;
us_dlist_sb_addlist_i:
...
;
; Implementation of us_dlist_sb_clear
;
us_dlist_sb_clear_i:
